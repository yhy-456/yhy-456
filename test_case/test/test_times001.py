...
#project_path = os.path.realpath(__file__).split("\\test_case\\test\\test_times001.py")[0]   #项目目录
project_path = os.path.realpath(__file__).split("/test_case/test/test_times001.py")[0].split("\\test_case\\test\\test_times001.py")[0]   #项目目录
...
#test
case_data = get_excel_data(file_path, "test", "test_times001")
