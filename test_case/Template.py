...
#project_path = os.path.realpath(__file__).split("\\test_case\\SheetName\\TestName.py")[0]   #项目目录
project_path = os.path.realpath(__file__).split("/test_case/SheetName/TestName.py")[0].split("\\test_case\\SheetName\\TestName.py")[0]   #项目目录
...
#SheetName
case_data = get_excel_data(file_path, "SheetName", "TestName")
