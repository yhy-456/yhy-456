...
#project_path = os.path.realpath(__file__).split("\\test_case\\a-service\\test_lottery002.py")[0]   #项目目录
project_path = os.path.realpath(__file__).split("/test_case/a-service/test_lottery002.py")[0].split("\\test_case\\a-service\\test_lottery002.py")[0]   #项目目录
...
#a-service
case_data = get_excel_data(file_path, "a-service", "test_lottery002")
